...
public class PublicTests {
    ...
    @Nested
    class StringMatcherTestMatrix {

        private final StringMatcher<Alpha> matcher = new StringMatcher<>(new PartialMatchLengthUpdateValuesAsMatrix<>(index, Alpha.makeString("BAB")));
